package com.teamnoyes.usedtransaction.mypage
...
import com.teamnoyes.usedtransaction.databinding.FragmentMyPageBinding
                ...
                auth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(requireActivity()) { task ->
                        if (task.isSuccessful){
                            ...
                            Toast.makeText(context, "이미 가입한 이메일이거나, 회원 가입에 실패했습니다.", Toast.LENGTH_SHORT).show()
                        }
                    }
            }
        }
