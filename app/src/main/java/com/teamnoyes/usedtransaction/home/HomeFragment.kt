...
import com.teamnoyes.usedtransaction.chatlist.ChatListItem
import com.teamnoyes.usedtransaction.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // binding이라는 전역변수가 nullable이기 때문에 onViewCreated에서 만큼은 null이 될 수 없는 임시 지역변수를 만든다.
